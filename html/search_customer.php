<?php
  ...
  if($_POST['cust']!=''){
    ...
    $data=mysql_query("
      select* 
      from customer
      where cust_ID='$cust' or cust_name='$cust'"); 
    //***更改結束
  }else{
...
<div class="nav-outer"> 
    ...
    <div class="select_sub show">
      <ul class="sub">
        ...
        <li class="sub_show"><a href="#nogo">客戶</a></li>
...
<form id="form1" name="form1" method="post" action="">
  <p>
    <input name="custID" type="text" id="custID" class="inp-form" value="<?php echo $custID?>" />
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
   <tr>
    ...
    <th class="table-header-repeat line-left"><a href="">國籍</a></th>
    <th class="table-header-repeat line-left"><a href="">聯絡人</a></th>
    <th class="table-header-repeat line-left"><a href="">聯絡信箱</a></th>
    <th class="table-header-repeat line-left"><a href="">電話</a></th>
    <th class="table-header-repeat line-left"><a href="">地址</a></th>
...
<!-- end footer -->
 ...
 <script>
  function del_confirm(id){
   if(confirm("確定刪除？")){
    location.href= "del(cust).php?id=" + id;
    }else{}
  }
  </script>
</html>
