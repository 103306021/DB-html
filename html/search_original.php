<?php
  ...
  if($_POST['orderID']!='' or $_POST['custID']!=''){
    $orderID=$_POST['orderID'];
    $custID=$_POST['custID'];
    $data=mysql_query("
      select order_o_ID, date_received, date_complete, order_original.cust_ID, customer.cust_name, customer.email_addr, customer.contact_name 
      from order_original, customer
      where order_original.cust_ID=customer.cust_ID and order_o_ID='$orderID' and cust_ID='$custID'"); //////////搜尋選項要改
  }else{
 // print("查無此資料！");
    $data=mysql_query("
      select order_o_ID, date_received, date_complete, order_original.cust_ID, customer.cust_name, customer.email_addr, customer.contact_name  
      from order_original, customer
      where order_original.cust_ID=customer.cust_ID");
  }
?>
...
<div class="nav-outer"> 
    ...
    <div class="select_sub show">
      <ul class="sub">
        <li class="sub_show"><a href="#nogo">原始訂單</a></li>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
   <tr>
    <th class="table-header-repeat line-left "><a href="">訂單編號</a>  </th>
    <th class="table-header-repeat line-left "><a href="">客戶編號</a></th>
    <th class="table-header-repeat line-left"><a href="">客戶名稱</a></th>
    <th class="table-header-repeat line-left"><a href="">聯絡人</a></th>
    <th class="table-header-repeat line-left"><a href="">聯絡信箱</a></th>
    <th class="table-header-repeat line-left"><a href="">收到訂單日期</a></th>
    <th class="table-header-repeat line-left"><a href="">要求出貨日期</a></th>
...
<!-- end footer -->
 ...
 <script>
  function del_confirm(id){
   if(confirm("確定刪除？")){
    location.href= "del(ori).php?id=" + id;
    }else{}
  }
  </script>
</body>
