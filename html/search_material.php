...
<div class="nav-outer"> 
    ...
    <div class="select_sub show">
      <ul class="sub">
        ...
        <li class="sub_show"><a href="#nogo">原料</a></li>
      </ul>
    </div>
    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
    </li>
...
<form id="form1" name="form1" method="post" action="">
  <p>
    <input name="matName" type="text" id="matName" class="inp-form" value="<?php echo $matName?>" />
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
   <tr>
    ...
    <th class="table-header-repeat line-left"><a href="">布寬</a></th>
    <th class="table-header-repeat line-left"><a href="">損耗</a></th>
...
<!-- end footer -->
 ...
 <script>
  function del_confirm(id){
   if(confirm("確定刪除？")){
    location.href= "del(mat).php?id=" + id;
    }else{}
  }
  </script>
