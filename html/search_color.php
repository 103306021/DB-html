<?php
  ...
  if($_POST['colorID']!=''){
    ...
    $data=mysql_query("select* from color");
  }
?>
...
<div class="nav-outer"> 
    ...
    <div class="select_sub show">
      <ul class="sub">
        ...
        <li class="sub_show"><a href="#nogo">色碼</a></li>
...
<form id="form1" name="form1" method="post" action="">
  <p>
    <input name="colorID" type="text" id="colorID" class="inp-form" value="<?php echo $colorID?>" />
...
<!-- end footer -->
 ...
 <script>
  function del_confirm(id){
   if(confirm("確定刪除？")){
    location.href= "del(color).php?id=" + id;
    }else{}
  }
  </script>
</html>
